            	...
            	<ul>
            		...
            		<li class="menu">
            			<a href="/admin/ajoutProduit.php">
							...
							<p class="nom-menu">Ajouter des produits</p>
            			</a>
            		</li>
            	</ul>
            </nav>
