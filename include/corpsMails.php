        ...
        <html>
            <body>
                <div align=\"center\" id=\"message-container\">
                    ...
                    <a href=\"http://localhost/school/ecommerce/controllers/mailVerificationController.php?email=$client_email&confirm_token=$confirm_token\">Confirmez votre compte</a>
                </div>
            </body>
        </html>
        ";
