            ...
            <div class="row">
                ...
                <div id="div-b" class="col-lg-6">
                    <div class="input-group mb-3">
                        <input type="text" style="width:600px;" class="form-control" placeholder="rechercher..." aria-label="Recipient's username" aria-describedby="button-addon2">
