...
<form class="user-form">
    <div id="container">
        ...
        <div id="detail-contaier" style="">
            ...
            <a href="../sessions/panier?articleID=<?=$article->getId()?>" id="" class="" style="height: 50px; text-decoration: none; border-radius: 8px; padding: 10px; background-color: #1eba71; color: #fff;">
                <!-- ICON DU PANIER -->
